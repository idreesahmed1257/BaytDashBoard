...
const SearchBar = () => {
    ...
    return (
        <div>
            <Paper sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', p: '20px 30px', mt: '20px', mb: '20px' }}>
                <Box >
                    <h1>Welcome Idrees Buddy</h1>
                </Box>
                <Box sx={{ display: 'flex', justifyContent: 'space-evenly', flexWrap: 'wrap', gap: '10px', alignItems: 'center' }}>
